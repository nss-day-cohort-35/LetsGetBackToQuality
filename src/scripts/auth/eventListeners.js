...
let authPanel = status => {
	return `
        ...
        <fieldset class="auth-section">
            <button class="auth-section__button submitBtn" id="auth-signin-button" value="">${status}</button>
        </fieldset>
        <fieldset class="auth-section">
            <button class="auth-section__button submitBtn" id="auth-signup-button" value="">Sign up</button>
       </fieldset>
       </section>
       <hr/>
    `;
...
let addSignIn = () => {
	return `
        ...
        <fieldset class="signin__fieldset">
            ...
            <input class="input textField" type="text" id="signin-username" placeholder="user name">
        </fieldset>

        <fieldset class="signin__fieldset">
            <label class="input">Password:</label>
            <input class="input textField" type="password" id="signin-password" placeholder="password">
        </fieldset>

        <fieldset class="signin__fieldset">
            <button class="input submitBtn" type="button" id="signin-button">Login!</button>
        </fieldset>
    `;
};
...
let addSignUp = () => {
	return `
        ...
        <fieldset class="signup__fieldset">
            ...
            <input class="input textField" type="text" id="signup-realname" placeholder="first and last names">
        </fieldset>

        <fieldset class="signup__fieldset">
            <label class="input">New username:</label>
            <input class="input textField" type="text" id="signup-username" placeholder="new user name">
        </fieldset>

        <fieldset class="signup__fieldset">
            <label class="input">New password:</label>
            <input class="input textField" type="password" id="signup-password" placeholder="new password">
        </fieldset>

        <fieldset class="signup__fieldset">
            <label class="input">New password confirmation:</label>
            <input class="input textField" type="password" id="signup-password-confirm" placeholder="new password">
        </fieldset>

        <fieldset class="signup__fieldset">
            <label class="input">e-Mail:</label>
            <input class="input textField" type="text" id="signup-email" placeholder="email address">
        </fieldset>

        <fieldset class="signup__fieldset">
           <button class="input submitBtn" type="button" id="signup-button">Save it!</button>
        </fieldset>
    `;
};
...
const verifyPassPhrase = passphrase => {
	...
	if (passphrase.length < passLength) {
		...
		characterSets.reduce(
			(match, set) => (match += containsCharacterFrom(set, passphrase)),
			0
